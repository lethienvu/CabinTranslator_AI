...
Usage:
    ...
    --env-dir   Custom venv directory (default: ~/Library/Application Support/Cabin Translator/mlx-env)
"""
...
def get_default_env_dir():
    ...
    app_support = os.path.expanduser("~/Library/Application Support/Cabin Translator")
