...
pub fn start_local_pipeline(
    ...
    let venv_python = format!("{}/Library/Application Support/Cabin Translator/mlx-env/bin/python3", home);
...
pub fn check_mlx_setup() -> Result<String, String> {
    let home = std::env::var("HOME").unwrap_or_else(|_| "/Users/phucnt".to_string());
    let marker = format!("{}/Library/Application Support/Cabin Translator/mlx-env/.setup_complete", home);
    let venv_python = format!("{}/Library/Application Support/Cabin Translator/mlx-env/bin/python3", home);
