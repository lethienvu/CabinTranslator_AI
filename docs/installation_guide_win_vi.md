...
Hướng dẫn từng bước cài đặt và sử dụng **Cabin Translator** trên Windows 10/11.
...
Tải file `.exe` mới nhất từ kênh phát hành nội bộ.
...
4. Tích **"Run Cabin Translator"** → nhấn **Finish**

![Hoàn thành — Chạy Cabin Translator](user_manual_win/mytrans_win_06.png)
